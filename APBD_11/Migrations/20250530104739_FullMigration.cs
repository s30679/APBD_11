    ...
    public partial class FullMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ból i gorączka", "Paracetamol", "Tabletki" },
                    { 2, "Ból głowy", "Apap", "Tabletki" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1900, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Adam", "Mickiewicz" },
                    { 2, new DateTime(1990, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ewa", "Konopka" }
                });
